...
class bot:
    ...
    admin = ['U3c6a47257d656187515d46072a337333','U99bd52a54e27fedddf25c0ac9440b88a']
    
    # 陳南安
    an_id   = 'U3c6a47257d656187515d46072a337333'
    ...
    def send_text(self, msg):
        ...
        line_bot_api.multicast(self.admin , TextSendMessage(text=msg))
